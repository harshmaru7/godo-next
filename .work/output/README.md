# Digitalocean Go Library

[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-Built%20with%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=Digitalocean%2FGo)

The Digitalocean Go library provides convenient access to the Digitalocean APIs from Go.
...
```go
response, err := client.PostV21ClicksKubernetes(...)
if err != nil {
...
```go
response, err := client.WithRawResponse.PostV21ClicksKubernetes(...)
if err != nil {
    return err
}
...
response, err := client.PostV21ClicksKubernetes(ctx, ...)
```
...
response, err := client.PostV21ClicksKubernetes(ctx, request, ...)
```
